...
# Тот же вопрос, набранный иначе: другие пробелы и порядок вариантов.
...
near = (base.replace("Вопрос:\n", "Вопрос:\n  ")
            ...
            .replace("0. тиазидный диуретик\n1. ингибитор ангиотензинпревращающего фермента\n"
                     "2. дигидропиридиновый блокатор кальциевых каналов",
                     "0) дигидропиридиновый блокатор кальциевых каналов\n"
                     "1) тиазидный диуретик\n"
